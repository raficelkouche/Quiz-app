  ...
  INSERT INTO questions (quiz_id, question)
  VALUES (7, `Don't make so much noise. Noriko ___ to study for her ESL test!`);
  INSERT INTO questions (quiz_id, question)
  VALUES (7, `Jun-Sik ___ his teeth before breakfast every morning.`);
  INSERT INTO questions (quiz_id, question)
  VALUES (7, `Sorry, she can't come to the phone. She ___ a bath!`);
  INSERT INTO questions (quiz_id, question)
...
Mary: "I'm trying to fix my calculator."`);
  ...
  INSERT INTO questions (quiz_id, question)
  VALUES (8, `Sorry, you can't borrow my pencil. I ___ it myself.`);
  --q39^
  INSERT INTO questions (quiz_id, question)
  ...
  INSERT INTO questions (quiz_id, question)
  VALUES (9, `The number of official food groups on the USDA's Food Pyramid is:`);
  ---q43^
  INSERT INTO questions (quiz_id, question)
  ...
  --q50^
  INSERT INTO questions (quiz_id, question)
  VALUES (11, `Mario's name wasn't fully decided at the time – what was he known as in the Donkey Kong days?`);
  INSERT INTO questions (quiz_id, question)
